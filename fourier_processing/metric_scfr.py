...
# -----------------------------
if len(sys.argv) != 3:
    print("Usage: python add_metric_no_header.py <input_file> <output_file>")
    sys.exit(1)
...
# -----------------------------
# Column names for your file
# -----------------------------
columns = [
    "Region", "Window_Size", "Chromosome", "SCFR_Name",
    "Num_Raw_Peaks", "Top_Peak_Count", "Frequencies",
    "Magnitudes", "Periods"
]
