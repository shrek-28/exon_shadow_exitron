...
for file in files:
    ...
    df = df[['exon_count', 'upstream_len_in_scfr']]
    ...
    # -----------------------------
    groups = [group['upstream_len_in_scfr'].values for _, group in df.groupby('exon_count')]
...
results_df.to_csv("statistical_analysis/exon_count_vs_shadow/results/upstream_exon_shadow_vs_exon_count.csv", index=False)
