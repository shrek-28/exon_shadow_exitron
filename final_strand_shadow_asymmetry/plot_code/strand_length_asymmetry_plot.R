...
df <- read.csv("C://Users//admin//Desktop//Coding//exon_shadow_exitron//final_strand_shadow_asymmetry//intermed_data//strand_length_asymmetry_summary.csv", check.names = FALSE)
...
ggplot(df_long, aes(x = species_label, y = asymmetry, group = dataset, color = dataset)) +
  ...
  # Labels
  labs(
    title = "Strand Length Asymmetry across Primate Species",
    x = "Species",
    y = "Asymmetry",
    color = "Dataset"
  ) +
...
ggsave("C://Users//admin//Desktop//Coding//exon_shadow_exitron//final_strand_shadow_asymmetry//plots//strand_length_asymmetry.pdf", width=10, dpi=300, height=7)